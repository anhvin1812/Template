...
namespace App.Website.Fillters
{
    public class ServiceAuthorizationAttribute : AuthorizationFilterAttribute
    {
        ...
        public override void OnAuthorization(HttpActionContext actionContext)
        {
...
#endif
            //var currentController = actionContext.ControllerContext.Controller as ControllerBase;
            ...
            //if (currentController.FirstCheck)
            //    currentController.FirstCheck = false;
        ...
        //        var isActive = IsActiveMember(actionContext, memberId.Value) || IsOnboardingCandidate(actionContext, memberId.Value);

        //        var host = authInfo != null ? authInfo.Host : "";
        //        //var isValidHost = host == request.Headers.Referrer.Host;
        //        var isValidHost = true;

        //        if (cookieTicket.Expiration >= System.DateTime.Now)
        //            result = !username.IsNullOrEmpty() && isTrusted && isActive && isValidHost;
        //    }
        ...
        //protected virtual bool IsActiveMember(HttpActionContext actionContext, int memberId)
        //{
        //    bool isActive;
        //    using (var memberService = actionContext.Resolve<IMemberService>())
        //    {
        //        isActive = memberService.IsActive(memberId);
        //    }
        //    return isActive;
        //}

        //protected virtual bool IsOnboardingCandidate(HttpActionContext actionContext, int memberId)
        //{
        //    bool isActive;
        //    using (var memberService = actionContext.Resolve<IMemberService>())
        //    {
        //        isActive = memberService.IsOnboardingMember(memberId);
        //    }
        //    return isActive;
        //}
        ...
        //    var claimsPrincipal = controller != null ? controller.CurrentClaimsIdentity : null;
        ...
        //{
        //    var isAllowed = false;
        //    if (claimValue.CompareTo(level) >= 0)
        //        isAllowed = true;
        //    return isAllowed;
        ...
        //    Entities.IdentityManagement.Member member;
        //    using (var memberService = actionContext.Resolve<IMemberService>())
        //    {
        //        member = memberService.GetMemberEntityById(memberId.Value);
        //    }
        ...
        //    if (member.MemberProfile != null && member.MemberProfile.RoleId != null)
        //    {
        //        var claim = new Claim(SherpaClaims.RoleId, member.MemberProfile.RoleId.Value.ToString(CultureInfo.InvariantCulture), "http://www.ww3.org/2001/XMLSchema#string", "LOCAL AUTHORITY", "LOCAL AUTHORITY");
        //        claims.Add(claim);
        //    }
        ...
        //    using (var security = actionContext.Resolve<ISecurityService>())
        //    {
        //        permissions = security.SetPermissions(memberId, networkId);
        //        var groupsAdmin = security.GetGroupsAdmin(member.MemberId, member.NetworkId ?? 0);
        //        if (groupsAdmin != null)
        //        {
        //            claims.Add(groupsAdmin);
        //        }
        //    }
