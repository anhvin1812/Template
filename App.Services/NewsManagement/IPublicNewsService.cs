...
namespace App.Services.NewsManagement
{
    ...
    {
        IEnumerable<PublicNewsSummary> GetAll(string keyword, DateTime? startDate, DateTime? endDate, int? categoryId, int? tagId, int? page, int? pageSize, ref int? recordCount);
